      ...
      <div className="top">
        <div className="box1">
          ...
          <p style={{ marginTop: "8px", lineHeight: "1.5rem" }}>
            Gateway to knowledge, discovery, and lifelong learning for all GDF
        ...
        <div className="box4">
          ...
          <div className="item">
            ...
            <span>Gyan Deep Foundation, Tulsipur Dang</span>
          </div>
          <div className="item">
            <AiOutlineMail className="icon" />
            <span>gyandeep_lib@gmail.com</span>
          </div>
          <div className="item">
            <AiOutlinePhone className="icon" />
            <span>082-520000</span>
          </div>
        </div>
      </div>
      <div className="bottom">
        <span>
          &copy;2025 Copyright : GDF Library Management System, Dang
        </span>
      </div>
    </footer>
  );
